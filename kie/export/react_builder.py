...
'''
    ...
    def _generate_dashboard_component(self, src_dir: Path, data_path: Path):
        """Generate KDS-compliant Dashboard component."""
        # Read KDS template
        kds_template_path = Path(__file__).parent / "dashboard_template_kds.tsx"
        if kds_template_path.exists():
            template_content = kds_template_path.read_text()
