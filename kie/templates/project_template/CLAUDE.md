...
### Charts (use matplotlib with brand settings)
```python
import matplotlib.pyplot as plt

# Brand-compliant setup
plt.style.use('dark_background')
plt.rcParams['figure.facecolor'] = '#1E1E1E'
plt.rcParams['axes.facecolor'] = '#1E1E1E'
plt.rcParams['axes.grid'] = False  # No gridlines
plt.rcParams['font.family'] = 'Arial'  # Inter fallback

KEARNEY_COLORS = ['#7823DC', '#9B4DCA', '#C4A6E8', '#5B1BA9', '#FF6B6B', '#4ECDC4']

fig, ax = plt.subplots(figsize=(10, 6))
ax.bar(labels, values, color=KEARNEY_COLORS[0])
ax.set_title('Title Here', color='white', fontsize=14, fontweight='bold')
...
plt.savefig('outputs/chart.png', dpi=150, bbox_inches='tight',
